...
#First we import libraries that do all the heavy lifting. If you don't have them installed, follow instructions in readme:
import pandas as pd
...
print("Clustirng complete, check directory for new file 'clustered_survey.csv' which contains a new column called 'Cluster' at far right")
